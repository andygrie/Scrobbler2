...
export class ConfirmDialogTrackInfo implements OnInit{
    ...
    constructor(public dialogRef: MdDialogRef<ConfirmDialogTrackInfo>, 
                private trackService : TrackService,
                private localStorageService : LocalStorageService) {
    }

    loadInfo() : void{
        this.trackService.getInfo(this.artist, this.title, this.localStorageService.get('name').toString()).then(data =>{
