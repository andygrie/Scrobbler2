...
export class ArtistsComponent implements OnInit {
  ...
  @HostListener('window:scroll', ['$event'])
    ...
    loadMoreArtists() : void{
      ...
      this.userService.getWeeklyArtistChart(this.startDate, this.endDate, this.localStorageService.get('name').toString()).then(data => {
    ...
    goToArtist(artistName : string) : void{
        this.dialogService
        .confirmAlbumsOfArtistDialog(artistName, [this.localStorageService.get('name').toString()], this.startDate, this.endDate)
        .subscribe(res => {
          if(res)
    ...
    getImageOfArtist(artist : any) : Promise<any> {
      return this.artistService.getInfo(artist.name, this.localStorageService.get('name').toString()).then(data => {
